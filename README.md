...
|---|---|---|
| Auto-remediated | MC-01, MC-04, MC-08 | Reversible, additive changes with no availability impact |
| Human approval required | MC-02, MC-03, MC-05, MC-06, MC-07 | Touch access control, network exposure, or have cost/availability trade-offs |
